...
if(isset($_GET['id']))
{
  ...
  $sname = $row['sectorname'];
  $simage = $row['sectorimage'];
  }
if(isset($_POST['btnupdate']))
{
  $sectorid = $_POST['txtid'];
    $sname = $_POST['txtname'];
  $update = "Update sector Set sectorname = '$sname '
  where sectorid = '$sectorid' ";
...
if (isset($_POST['btnupload'])) 
{
 ...
 <head>
   ...
   <title>Justice For You - Profile</title>
...
<?php include('adminheader.php') ?>
 <body>
  ...
  <form action='sectoredit.php' method='POST' enctype="multipart/form-data">
    <legend>Sector Edit</legend>
    <div class="col-auto profile-image">
                    <figure class="figure col-md-2 col-sm-3 col-xs-12">
                                    <img class="img-rounded img-responsive" src="<?php echo $simage ?>" alt="<?php echo $adname ?>" width='45px'>
                                </figure>
                ...
                <div class="row form-row">
                  <div class="col-12 col-sm-6">
                    <div class="form-group">
                      <label>SpecialitieID</label>
                      <input class='seditid' type="text" name="txtid" value = "<?php echo $_GET['id'] ?>" class='form-control' readonly = ""> 
                    </div>
                    <div class="form-group">
                      <label>Specialities</label>
                      <input class='seditname'  type="text" name="txtname" value = "<?php echo $sname?>" class='form-control' required=""> <br>
                    </div>
                  </div>
                  <div class="col-12 col-sm-6">
                    <div class="form-group">
                ...
                <input type='submit' name='btnupload' class="btn btn-xs btn-primary" value='Upload'>
