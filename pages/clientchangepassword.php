  ...
  if($Current!=$password)
   ...
   else
   {
     $update=
       "UPDATE client SET
                cpassword='$New',
               cconpassword='$Confirm'
                WHERE cpassword='$Current' and cemail='$Email'";
...
<body>
 ...
 <form action='clientchangepassword.php' method='POST' enctype="multipart/form-data" class="login100-form validate-form">
