...
if(isset($_POST['btnsignup']) )
{
  ...
  $pricepersession=$_POST['txtpricepersession'];
  $gender=$_POST['txtgender'];
  $lawyerid=AutoID('lawyer','lawyerid','lawyer_',6);
...
if(!$error)  
     {
      $insert = "INSERT INTO `lawyer`(`lawyerid`, `lname`, `lnrcnumber`, `lage`, `gender`, `lphoneno`, `lemail`, `laddress`, `lposition`, `pricepersession`, `lpassword`, `lconfirmpassword`, `leducation`, `lsalary`, `lexperience`, `lavatar`) VALUES ('$lawyerid','$name','$nrc','$age','$gender','$phnumber','$email','$address','$position','$pricepersession', '$password',' $conpass','$education','$salary','$jobexperience','$filename')";
...
<div class="container">
  ...
  <div class="row">
        <form action= "Lawyersignup.php" method="POST" enctype="multipart/form-data">
          <div class="col-sm-12">
            <div class="row">
            ...
            <div class="row">
              <div class="col-sm-6 form-group">
                ...
                <div class="col-sm-6 form-group">
                 <label for="inputpricepersession">Price Per Session</label>
                       <select size="1" class='form-control' name='txtpricepersession' id="inputpricepersession">
                 ...
                 <label for="inputgender">Gender</label>
                       <select size="1" class='form-control' name='txtgender' id="inputgender">
