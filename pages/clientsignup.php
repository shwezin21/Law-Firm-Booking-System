...
if(isset($_POST['btnsignup']) )
{
  ...
  $clientid=AutoID('client','clientid','client_',6);
...
if(!$error)  
     {
      $insert = "INSERT INTO `client`(`clientid`, `clname`, `cnrcnumber`, `cage`, `cphoneno`, `cemail`, `caddress`, `cpassword`, `cconpassword`, `cavatar`)   
                              VALUES  ('$clientid','$name','$nrc','$age','$phnumber','$email','$address','$password',' $conpass','$filename')";
...
<div class="container">
  ...
  <div class="row">
        <form action= "clientsignup.php" method="POST" enctype="multipart/form-data">
          <div class="col-sm-12">
            <div class="row">
            ...
            <div class="row">
              <div class="col-sm-6 form-group">
                 <label for = "inputfile">Upload Profile</label>
                   <input type = "file" name="fileavatar" id="inputfile">
              </div>  
            </div>        
  ...
  <img src='../image/eyeicon.png'width='25px' height='25px' class='eyeicon' onclick='myFunction1()'>
          ...
          <div class="form-group">
            ...
            <input type="text" placeholder="Enter Phone Number Here.." class="form-control" name='txtphnumber' required=""  pattern="[09]{2}[0-9]{9}">
          </div>    
          <div class="form-group">
            <label>Email Address</label>
            <input type="email" placeholder="Enter Email Address Here.." class="form-control" name='txtemail' required>
          </div>  
